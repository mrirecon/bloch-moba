...
# Seperate T1 maps
bart slice 7 0 results/t1_test{,1}	# Hyp.Sec. inversion, Slice Profile
bart slice 7 1 results/t1_test{,2}	# Perfect inversion, single-spin
bart slice 7 2 results/t1_test{,3}	# Perfect inversion, Slice Profile
